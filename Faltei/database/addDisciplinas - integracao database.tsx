...
// import { Text, useColorScheme, SafeAreaView, StyleSheet, TextInput, TouchableOpacity, Alert } from 'react-native';
...
// import { useDisciplinaDatabase, DisciplinaDatabase } from '@/database/useDisciplinaDatabase';
...
//   const [disciplinas, setDisciplinas] = useState<DisciplinaDatabase[]>([]);
//   const [search, setSearch] = useState('');

//   const disciplinaDatabase = useDisciplinaDatabase()

//   async function saveOnDatabase() {
//     try {
//       if (isNaN(Number(numCreditos))) {
//         return Alert.alert("Creditos", "A quantidade de creditos deve ser um número inteiro.")
//       }

//       const response = await disciplinaDatabase.create({
//         sigla: siglaDisciplina,
//         nome_disciplina: nomeDisciplina,
//         nome_professor: nomeProfessor,
//         creditos: Number(numCreditos),
//       });
...
//     try {
//       const response = await disciplinaDatabase.searchBySigla(search)
